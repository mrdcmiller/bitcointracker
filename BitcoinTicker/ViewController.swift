...
//  BitcoinTicker
//
// Created by Doug Miller on 2/23/19.
//  
//
...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    //TODO: Place 3 UIPickerView delegate methods here
...
//    *************************************************************
    ...
    func updateCoinData(json : JSON) {
        ...
        if let coinResult = json["bid"].double {
            bitcoinPriceLabel.text = currencySelected +
            String(coinResult)
        } else {
